...
* `user_PE_predict` and `user_PE_predict_params`: The former is an optional, user supplied function to generate predictions from the output of `user_PE_fit`. If not supplied, defaults to `predict`. The latter is a named list of optional parameters to be used by `user_PE_predict`.
